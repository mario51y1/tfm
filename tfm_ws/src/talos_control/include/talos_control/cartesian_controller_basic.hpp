...
void cartesian_controller_class::starting(const ros::Time &time) {
    ...
    std::string urdf_path = ros::package::getPath("talos_control") + std::string("/src/model.urdf");
    ...
    std::vector<std::string> articulaciones_bloqueadas{
        ...
        "arm_left_5_joint", "arm_left_6_joint", "arm_left_7_joint", "hip_waist_joint", "waist_chest_joint",
        "updown_head_joint", "leftright_head_joint",
    };
